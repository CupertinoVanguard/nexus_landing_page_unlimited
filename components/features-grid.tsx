export default function FeaturesGrid() {
  const cards = [
    { title: "Session replay", body: "Reconstruct user paths and surface anomalies instantly." },
    { title: "Churn detection", body: "Spot early churn signals and trigger playbooks automatically." },
    { title: "Feature adoption", body: "Track adoption and alert on dips in engagement." },
    { title: "Cohort insights", body: "Segment users dynamically and summarize behavior changes." },
  ];
