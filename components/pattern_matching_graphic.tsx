    ...
    <div className="relative w-full h-full flex items-center justify-center p-1">
      ...
      <div className="hidden sm:flex items-center justify-between w-full h-full">
        ...
        <div className="relative w-[50%] h-full flex items-center justify-center">
          <div className="relative w-40 h-48">
            ...
            <div className="absolute top-2 left-16 z-[1]">
              <div className="w-20 bg-gray-100 border border-gray-200 rounded-lg p-2.5 flex flex-col justify-between">
                <p className="text-xs text-gray-900 font-medium mb-1">Tickets</p>
            ...
            <div className="absolute top-14 left-20 z-[13]">
              <div className="w-20 bg-gray-100 border border-gray-200 rounded-lg p-2.5 flex flex-col justify-between shadow-lg">
                <p className="text-xs text-gray-900 font-medium mb-1">Tickets</p>
                <div className="flex items-center justify-end mt-auto">
                  <div className="w-4 h-4 rounded bg-gray-300"></div>
                </div>
            ...
            <div className="absolute top-0 left-0 z-[7]">
              <div className="w-20 bg-gray-100 border border-gray-200 rounded-lg p-2.5 flex flex-col justify-between">
                <p className="text-xs text-gray-900 font-medium mb-1">Logs</p>
                <div className="flex items-center justify-end mt-auto">
                  <div className="w-4 h-4 rounded bg-gray-300"></div>
                </div>
              </div>
        ...
        <div className="flex items-center justify-center w-[15%]">
          <div className="flex items-center">
            ...
            <div className="w-0 h-0 border-t-[6px] border-t-transparent border-b-[6px] border-b-transparent border-l-[10px] border-l-gray-700"></div>
          </div>
        </div>

        {/* Issue card on right */}
        <div className="w-[25%] flex items-center justify-center">
          <div className="w-20 bg-gray-100 border border-gray-200 rounded-lg p-2.5 shadow-lg flex flex-col justify-between">
            <p className="text-xs text-gray-900 font-medium mb-1">Issue</p>
            <div className="flex items-center justify-end mt-auto">
      ...
      <div className="flex sm:hidden flex-col items-center justify-between w-full h-full py-2">
        ...
        <div className="relative h-[55%] flex items-center justify-center">
          <div className="relative w-32 h-36">
            ...
            <div className="absolute top-1 left-12 z-[1]">
              <div className="w-16 bg-gray-100 border border-gray-200 rounded-lg p-2 flex flex-col justify-between">
                <p className="text-[10px] text-gray-900 font-medium mb-1">Tickets</p>
                <div className="flex items-center justify-end mt-auto">
            ...
            <div className="absolute top-11 left-14 z-[13]">
              <div className="w-16 bg-gray-100 border border-gray-200 rounded-lg p-2 flex flex-col justify-between shadow-lg">
                <p className="text-[10px] text-gray-900 font-medium mb-1">Tickets</p>
                <div className="flex items-center justify-end mt-auto">
                  <div className="w-3 h-3 rounded bg-gray-300"></div>
                </div>
            ...
            <div className="absolute top-0 left-0 z-[7]">
              <div className="w-16 bg-gray-100 border border-gray-200 rounded-lg p-2 flex flex-col justify-between">
                <p className="text-[10px] text-gray-900 font-medium mb-1">Logs</p>
                <div className="flex items-center justify-end mt-auto">
                  <div className="w-3 h-3 rounded bg-gray-300"></div>
                </div>
              </div>
        ...
        <div className="flex flex-col items-center justify-center h-[15%]">
          ...
          <div className="w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-t-[10px] border-t-gray-700"></div>
        </div>

        {/* Issue card on bottom */}
        <div className="h-[25%] flex items-center justify-center">
          <div className="w-16 bg-gray-100 border border-gray-200 rounded-lg p-2 shadow-lg flex flex-col justify-between">
            <p className="text-[10px] text-gray-900 font-medium mb-1">Issue</p>
            <div className="flex items-center justify-end mt-auto">
