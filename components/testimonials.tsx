      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="text-sm font-medium text-gray-200">
            ...
            <div
                className="absolute right-6 bottom-6 flex h-8 w-8 items-center justify-center rounded-full border border-gray-700/50 bg-gray-800/65 cursor-pointer text-gray-200 opacity-100 transition-opacity group-hover/card:opacity-100"
                aria-hidden="true"
              >
                <Rocket className="h-5 w-5 rotate-315"/>
              </div>
